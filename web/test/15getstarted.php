...
<!-- COMMENT:  section 1 left   -->
    <div class="info"  >
        ...
        <h3 style="text-align:center">Collaborative project management is foundational to project success.</h3> 
        <p><br>All other project parameters begin there. 
            <br><br> Involving Construction Collaboratory as a project consultant at the outset of your project brings experienced resources to your project team:
            <br><br> --I will be looking out for your project from the get-go.
        </p> 
        <div>
        ...
        </P><P>Thank you for your interest.  In my experience, client satisfaction with these new collaborative project delivery systems always meets, but mostly exceeds, client expectations.  Let’s see if together we can help you knock one out of the park, too! 
        </P>
        <P>Kevin A. Delorey </P>
