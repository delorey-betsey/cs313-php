...
<div class="sub-banner">
    ...
    <div style="color:#FFCD00">Methods</div>
</div>
...
<!-- COMMENT:  top nav   -->
    <div class="topnav2" >
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/modules/topnav2.php'; ?>
    </div>

<!-- COMMENT:   section 1 left  -->
    <div class="info"  >
        <h1 style="text-align:center;">Today's Construction Project Management</h1>
        <audio controls>
            <source src="04methods/kadrecording.mp3" type="audio/ogg">
            <source src="04methods/kadrecording.mp3" type="audio/mpeg">
...
<!-- COMMENT:  IPD  -->
    ...
    <img src="04methods/ipdlogo.JPG" alt= "IPD integrated project development" style="border:10px solid #75ad3e; margin-left:50px; margin-right:50px;" height="150">
...
<!-- COMMENT:  LEAN  -->
    ...
    <img src="04methods/leanlogo.JPG" alt= "Lean project management" style="border:10px solid #75ad3e; margin-left: 50px; margin-right: 50px;" height="150">
...
<!-- COMMENT:  BIM  -->
    ...
    <img src="04methods/bimlogo.JPG" alt= "BIM building information modeling" style="border:10px solid #75ad3e; margin-left:50px; margin-right:50px;" height="150">
