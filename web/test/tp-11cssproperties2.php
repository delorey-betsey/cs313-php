...
<div class="teachingpresentation">
    <h2>MORE PROPERTIES--ENDLESS POSSIBILITIES</h2>
...
<tr>
    ...
    <td>
        ...
        <br>padding-top
        <br>page-break-after
        <br>page-break-before
        <br>page-break-inside
        <br>perspective
        <br>perspective-origin
        <br>position
        <br>quotes
        <br>resize
        <br>right
    ...
    <td>
        text-align-last
        <br>text-decoration
        <br>text-decoration-color
        <br>text-decoration-line
        <br>text-decoration-style
        <br>text-indent
        <br>text-justify
        <br>text-overflow
        <br>text-shadow
    ...
    <td>
        transition-delay
        <br>transition-duration
        <br>transition-property
